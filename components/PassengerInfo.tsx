...
import { InquiryData, Passenger } from '../types';
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-slate-200">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="font-bold text-sm text-slate-800">Secure Transmission</h4>
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">Your data is protected by industry-standard encryption protocols.</p>
          </div>
        </div>
        <div className="flex gap-4">
          <div className="text-secondary"><span className="material-symbols-outlined text-3xl">workspace_premium</span></div>
          <div>
            <h4 className="font-bold text-sm text-slate-800">Official Partner</h4>
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">Authorized travel partner for major international transport routes.</p>
          </div>
        </div>
        <div className="flex gap-4">
          <div className="text-primary"><span className="material-symbols-outlined text-3xl">headset_mic</span></div>
          <div>
            <h4 className="font-bold text-sm text-slate-800">Expert Support</h4>
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">Our specialist team is based in Kensington and available 24/7.</p>
          </div>
        </div>
      </div>
    </div>
